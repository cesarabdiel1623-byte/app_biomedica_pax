...
class _AddressPickerScreenState extends State<AddressPickerScreen> {
  ...
  Future<void> _loadSavedAddresses() async {
    ...
    try {
      ...
      if (mounted) setState(() { _savedAddresses = list; _loadingSaved = false; });
    } catch (_) {
  ...
  Future<void> _reverseGeocode(LatLng latLng) async {
    ...
    try {
      ...
      final res = await http.get(url, headers: {'User-Agent': 'GoMedicalApp/1.0'});
      if (res.statusCode == 200) {
        ...
        if (data != null && data['address'] != null) {
          ...
          final parts = [streetPart, city, stateVal].where((s) => s.isNotEmpty).toList();
          final full = parts.join(', ');
          if (mounted) {
            setState(() => _currentAddress = full.isNotEmpty
                ? full
    ...
    return Scaffold(
      ...
      body: Column(children: [
            ...
            Positioned(
              ...
              child: FloatingActionButton.small(
                ...
                child: _loadingGps
                    ? const SizedBox(
                        width: 18, height: 18,
                        child: CircularProgressIndicator(strokeWidth: 2, color: _kPrimaryAddr))
        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.label_outline, color: _kPrimaryAddr),
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: _saving
                  ...
                  : const Text('Confirmar esta dirección',
        ...
        if (!_loadingSaved && _savedAddresses.isNotEmpty) ...[
              ...
              itemBuilder: (_, i) {
                ...
                return Card(
                  ...
                  shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(
                      color: a.isDefault
                          ? _kPrimaryAddr.withValues(alpha: 0.5)
                  ...
                  child: ListTile(
                    ...
                    leading: CircleAvatar(
                      ...
                      backgroundColor: a.isDefault
                          ? _kPrimaryAddr.withValues(alpha: 0.1)
                          : Colors.grey.shade100,
                      child: Icon(
                        Icons.location_on,
                        size: 18,
                        color: a.isDefault ? _kPrimaryAddr : Colors.grey.shade500,
                      ),
                    ),
                    title: Text(
                      a.label,
                    ...
                    onTap: () {
                      AddressService.setDefault(a.id)
          ...
          const Expanded(
            child: Center(child: CircularProgressIndicator(color: _kPrimaryAddr)),
          ),
      ]),
    );
  }
