  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        transform: Matrix4.diagonal3Values(_isTapped ? 1.02 : 1.0, _isTapped ? 1.02 : 1.0, 1.0),
          ...
          children: [
            SizedBox(
              ...
              child: Stack(children: [
                  ...
                  child: Container(
                    ...
                    child: product.mainImageUrl != null
                      ? Hero(
                          ...
                          child: UiHelpers.networkImage(product.mainImageUrl!, fit: BoxFit.contain, iconSize: 32),
                        )
                      : Hero(
                          tag: 'product-image-${product.id}',
                          child: _placeholder(),
                ...
                if (product.activePromotion != null || product.salesCount >= 50)
                    ...
                    child: Container(
                      ...
                      child: MarqueeText(
                        text: (product.activePromotion != null)
                          ? ((product.activePromotion!.campaignName != null && product.activePromotion!.campaignName!.isNotEmpty)
                              ? product.activePromotion!.campaignName!.toUpperCase()
                              : (product.activePromotion!.promotionName != null && product.activePromotion!.promotionName!.isNotEmpty)
                                ? product.activePromotion!.promotionName!.toUpperCase()
                                : 'PROMOCIÓN')
                          : 'MÁS VENDIDO',
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (product.productCondition != null &&
                      (product.productCondition == 'preowned' || product.productCondition == 'remanufactured')) ...[
                    const SizedBox(height: 5),
                    Text(
