...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _slideUpAnim = Tween<Offset>(begin: const Offset(0, 0.25), end: Offset.zero)
        .animate(CurvedAnimation(parent: _animController, curve: Curves.easeOut));
    _slideDownAnim = Tween<Offset>(begin: const Offset(0, -0.25), end: Offset.zero)
        .animate(CurvedAnimation(parent: _animController, curve: Curves.easeOut));
  ...
  Future<void> _signIn() async {
    ...
    try {
      ...
      if (error.code == 'invalid_credentials' || message.toLowerCase().contains('invalid login credentials')) {
        message = 'El correo electrónico o la contraseña son incorrectos. Por favor, verifícalos.';
      } else if (error.code == 'email_not_confirmed' || message.toLowerCase().contains('email not confirmed')) {
        message = 'El correo electrónico no ha sido verificado aún. Revisa tu bandeja de entrada.';
      } else if (error.code == 'user_not_found' || message.toLowerCase().contains('user not found')) {
  ...
  Future<void> _googleSignIn() async {
    ...
    try {
      ...
      if (currentUser != null && googleUser != null) {
        ...
        if (metadata['full_name'] == null || metadata['full_name'].toString().isEmpty) {
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: TextButton(
                                ...
                                child: const Text('¿Olvidaste tu contraseña?', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
                              ),
                            ),
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: _isLoading
                                    ...
                                    : const Text('INICIAR SESIÓN', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, letterSpacing: 1)),
                              ),
                            ),
                            ...
                            Wrap(
                              ...
                              children: [
                                const Text('¿No tienes cuenta? ', style: TextStyle(color: Color(0xFF757575), fontSize: 14)),
                                GestureDetector(
                                  onTap: () {
  ...
  Widget _buildInput({
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isFocused ? _primaryColor : const Color(0xFFE0E0E0),
          width: isFocused ? 1.6 : 1,
        ),
        boxShadow: isFocused
            ? [BoxShadow(color: _primaryColor.withOpacity(0.1), blurRadius: 8, offset: const Offset(0, 2))]
            : [],
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(icon, color: isFocused ? _primaryColor : const Color(0xFF9E9E9E), size: 20),
          suffixIcon: suffix,
