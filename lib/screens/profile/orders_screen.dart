...
class _OrdersScreenState extends State<OrdersScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Mis Pedidos', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)), backgroundColor: kPrimary, foregroundColor: Colors.white, elevation: 0),
      body: _loading
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              title: Row(
                                ...
                                children: [
                                  Text(o['order_number'] ?? 'Pedido', style: const TextStyle(fontWeight: FontWeight.bold, color: kNavy)),
                                  Container(
                                    padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                                    decoration: BoxDecoration(color: _statusColor(o['status']).withValues(alpha: 0.12), borderRadius: BorderRadius.circular(20)),
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text('Total: ${formatCurrency(total)}', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black87)),
                                ],
                              ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('No tienes pedidos aún', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: kNavy)),
          const SizedBox(height: 4),
