    ...
    return Scaffold(
      ...
      body: _loading
          ...
          ? LoadErrorState(
              ...
              genericTitle: 'Error al cargar equipos',
              genericMessage: 'No pudimos cargar tus equipos registrados.',
            )
          : _equipment.isEmpty
          ? _buildEmptyState()
          : RefreshIndicator(
...
class EquipmentDetailScreen extends StatelessWidget {
  ...
  Future<void> _launchWhatsApp(
    ...
    final message =
        'Hola, necesito soporte técnico o mantenimiento para mi equipo:\n\n'
        '• Equipo: $name\n'
        '• SKU/Modelo: $sku\n'
    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'No se pudo abrir WhatsApp. Por favor contacta al soporte al 529995266748.',
            ),
